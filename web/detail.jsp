            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="list-group">
                        <c:forEach var="content" items="${content_list}">
                            <a href="${pageContext.request.contextPath}/${content.type eq 'Lesson' ? 'lesson' : 'quiz'}?id=${content.id}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                <div>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-primary mb-5 py-3">
                        ...
                        <div class="py-3 px-4">
                            <a class="btn btn-block btn-secondary py-3 px-5" href="${pageContext.request.contextPath}/checkout?id=${course.id}">Pay and Enroll</a>
                        </div>
                    </div>
